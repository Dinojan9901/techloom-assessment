...
const SESSION_STORAGE_KEY = 'techloom.pos.sessionId';

/**
 * Every POS terminal (browser) gets one stable id. The backend scopes carts and
 * order history to it, which is what lets several terminals race each other for
 * the same stock without sharing a cart.
 */
